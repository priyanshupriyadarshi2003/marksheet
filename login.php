...
<style>
	body{
    background-image: url("niis-institute-of-information-science-management-bhubaneswar-260161.jpg");
...
<body class="bg-dark">
  ...
  <main id="main" >
		...
		<h1 class="text-dark text-center"><b><?php echo $_SESSION['system']['name'] ?></b></h1>
  		<div id="login-center" class="row justify-content-center">
  			<div class="card col-md-4">
                ...
                <button class="btn-sm btn-block btn-wave col-md-4 btn-primary m-0 mr-1">Login</button><br><br>
